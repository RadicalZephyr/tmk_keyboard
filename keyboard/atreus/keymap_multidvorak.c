...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_INS, KC_HOME,     KC_UP,   KC_END,   KC_PGUP,                   KC_UP,   KC_F7,   KC_F8,  KC_F9,  KC_F10,       \
         ...
         KC_NO,  KC__VOLUP,   KC_NO,   KC_NO,    KC_FN0,                    KC_FN5,  KC_F1,   KC_F2,  KC_F3,  KC_F12,       \
         KC_NO,  KC__VOLDOWN, KC_LGUI, KC_LSFT,  KC_BSPC, KC_LCTL, KC_LALT, KC_SPC, KC_FN3, KC_PSCREEN, KC_SLCK, KC_PAUSE), \
