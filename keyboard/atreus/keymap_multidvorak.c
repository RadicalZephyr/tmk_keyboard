...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_Q,   KC_W,   KC_E,    KC_R,    KC_T,                      KC_Y,    KC_U,   KC_I,    KC_O,    KC_P,    \
         ...
         KC_ESC, KC_TAB, KC_LGUI, KC_LSFT, KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,  KC_FN0, KC_QUOT, KC_LBRC, KC_ENT), \
  ...
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2),   SHIFT(KC_MINS), SHIFT(KC_EQUAL), SHIFT(KC_BSLS),                    KC_PGUP,     KC_7,   KC_8, KC_9, SHIFT(KC_8),    \
         ...
         KC_FN1,      SHIFT(KC_INS), KC_LGUI,        KC_LSFT,         KC_BSPC,         KC_LCTL, KC_LALT, KC_SPC,      KC_FN0, KC_0, KC_E, KC_RBRC),       \
  ...
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2),   KC_UP,       SHIFT(KC_MINS), SHIFT(KC_EQUAL),                    KC_PGUP,  KC_7,    KC_8, KC_9, SHIFT(KC_8),    \
         ...
         KC_FN7,      SHIFT(KC_INS), KC_LGUI,     KC_LSFT,        KC_BSPC,         KC_LCTL,  KC_LALT, KC_SPC, KC_FN6, KC_DOT,  KC_0, KC_EQUAL),      \
