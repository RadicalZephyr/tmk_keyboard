...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  /* 0: mostly letters */
  KEYMAP(KC_NO, KC_Q, KC_W, KC_E, KC_R,                             KC_Y, KC_U, KC_I, KC_O, KC_P, \
         KC_LSFT, KC_A, KC_S, KC_D, KC_F,                           KC_H, KC_J, KC_K, KC_L, KC_SCLN, \
         KC_Z, KC_X, KC_C, KC_V, KC_B,                              KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, \
         KC_ESC, KC_TAB, KC_LALT, KC_FN0, KC_SPC, KC_LCTL, KC_LGUI, KC_BSPC, KC_FN0, KC_MINS, KC_QUOT, KC_ENT), \
  ...
  KEYMAP(KC_NO, KC_9, KC_8, KC_7, KC_NO,                            KC_FN2, KC_NO, KC_FN2, KC_NO, KC_NO, \
         ...
         KC_ESC, KC_TAB, KC_LALT, KC_FN0, KC_SPC, KC_LCTL, KC_FN10, KC_FN17, KC_FN0, KC_FN16, KC_FN15, KC_NO)
};
